            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ url('cinema/create') }}" class="btn btn-outline-success">
                                ...
                                <tbody>
                                    @foreach ($cinemas as $cinema)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url("cinema/$cinema->id_cinema/edit") }}"
                                                    class="btn btn-outline-primary">
                                                    <i class="fa fa-edit"></i>&nbsp; Edit
                                                </a>

                                                <a href="{{ url("cinema/$cinema->id_cinema/delete") }}"
